...
<!--header end-->
       ...
       <div class="container">
        ...
        <h2 class="m-3">Product Categories</h2>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td><img height="50px" width="50px" src="<?php echo 'uploads/' . $row['product_image']?>" alt="image"></td>
                    ...
                    <td>
                      <a href="#" onclick="Edit_product(<?php echo $row['product_id']?>)">
                      ...
                      <a href="#" onclick="Delete_product(<?php echo $row['product_id']?>)">
...
<!-- delete modal start -->
<div class="modal fade" id="delete_product_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
